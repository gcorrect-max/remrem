  ...
  <div class="h-full overflow-auto p-6">
    ...
    <div v-else class="max-w-3xl mx-auto">
      <div class="bg-rail-surface border border-rail-border rounded p-6 space-y-3">
        <h1 class="font-sans text-base font-semibold text-rail-header">Software module not found</h1>
        <p class="font-mono text-xs text-rail-dim">
          No software module was found for id: <span class="text-rail-accent">{{ route.params.module }}</span>
        </p>
...
const item = computed(() => {
  ...
  return moduleCfgItems.software.find(entry => entry.id === moduleId) || null
})
